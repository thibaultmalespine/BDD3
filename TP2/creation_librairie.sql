...
CREATE DATABASE librairie ENCODING 'UTF8';

\echo [INFO] Connexion a la nouvelle base de donnees librairie
...
CREATE TABLE Auteur
   (
	...
	emailAuteur VARCHAR(40) NOT NULL UNIQUE -- manquait UNIQUE
   ) ;
...
CREATE TABLE Client
   (
	...
	emailClient VARCHAR(40) NOT NULL UNIQUE -- manquait UNIQUE
   ) ;
...
CREATE TABLE Livre
   (
	...
	titre VARCHAR(40),
    prix INT NOT NULL,
	lEditeur VARCHAR(40)  -- le NOT NULL etait en trop : on le prend pas en compte
